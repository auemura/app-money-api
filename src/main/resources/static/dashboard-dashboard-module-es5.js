...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["dashboard-dashboard-module"], {
  ...
  function srcAppDashboardDashboardModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    DashboardModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], primeng_panel__WEBPACK_IMPORTED_MODULE_2__["PanelModule"], primeng_chart__WEBPACK_IMPORTED_MODULE_3__["ChartModule"], _shared_shared_module__WEBPACK_IMPORTED_MODULE_4__["SharedModule"], _dashboard_routing_module__WEBPACK_IMPORTED_MODULE_5__["DashboardRoutingModule"]]]
    });
  ...
  function srcAppDashboardDashboardDashboardComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var DashboardComponent = /*#__PURE__*/function () {
      function DashboardComponent(dashboardService, decimalPipe) {
        var _this = this;
          ...
          tooltips: {
            callbacks: {
              label: function label(tooltipItem, data) {
                ...
                return label + _this.decimalPipe.transform(valor, '1.2-2');
              }
            }
          }
        };
      ...
      _createClass(DashboardComponent, [{
        ...
        key: "configurarGraficoPizza",
        value: function configurarGraficoPizza() {
          var _this2 = this;

          this.dashboardService.lancamentosPorCategoria().then(function (dados) {
            _this2.pieChartData = {
              labels: dados.map(function (dado) {
        ...
        key: "configurarGraficoLinha",
        value: function configurarGraficoLinha() {
          var _this3 = this;

          this.dashboardService.lancamentosPorDia().then(function (dados) {
            var diasDoMes = _this3.configurarDiasMes();

            var totaisReceitas = _this3.totaisPorCadaDiaMes(dados.filter(function (dado) {
              return dado.tipo === 'RECEITA';
            }), diasDoMes);

            var totaisDespesas = _this3.totaisPorCadaDiaMes(dados.filter(function (dado) {
              return dado.tipo === 'DESPESA';
            }), diasDoMes);
        ...
        key: "totaisPorCadaDiaMes",
        value: function totaisPorCadaDiaMes(dados, diasDoMes) {
          var totais = [];

          var _iterator = _createForOfIteratorHelper(diasDoMes),
              _step;
          ...
          try {
            for (_iterator.s(); !(_step = _iterator.n()).done;) {
              ...
              var _iterator2 = _createForOfIteratorHelper(dados),
                  _step2;
        ...
        key: "configurarDiasMes",
        value: function configurarDiasMes() {
          var mesReferencia = new Date();
          mesReferencia.setMonth(mesReferencia.getMonth() + 1);
          mesReferencia.setDate(0);
          var quantidade = mesReferencia.getDate();
          var dias = [];
    ...
    DashboardComponent.ɵfac = function DashboardComponent_Factory(t) {
      return new (t || DashboardComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_dashboard_service__WEBPACK_IMPORTED_MODULE_1__["DashboardService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common__WEBPACK_IMPORTED_MODULE_2__["DecimalPipe"]));
    };
    ...
    DashboardComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 11,
      vars: 4,
      consts: [[1, "container"], [1, "ui-g"], [1, "ui-g-12"], [1, "ui-g-12", "ui-md-6"], ["header", "Lan\xE7amentos por categoria"], ["type", "pie", 3, "data", "options"], ["header", "Lan\xE7amentos por dia"], ["type", "line", 3, "data", "options"]],
      ...
      directives: [primeng_panel__WEBPACK_IMPORTED_MODULE_3__["Panel"], primeng_chart__WEBPACK_IMPORTED_MODULE_4__["UIChart"]],
